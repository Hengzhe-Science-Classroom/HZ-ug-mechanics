// === The Mechanics · Interactive - Core Application ===
...
const App = {
    ...
    // --- Progress ---
    loadProgress() {
        try { this.progress = JSON.parse(localStorage.getItem('ug-mechanics-progress') || '{}'); }
        catch (e) { this.progress = {}; }
    },
    saveProgress() {
        try { localStorage.setItem('ug-mechanics-progress', JSON.stringify(this.progress)); } catch (e) {}
    },
